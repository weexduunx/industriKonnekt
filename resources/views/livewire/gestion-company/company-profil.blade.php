                ...
                <div class="card-body p-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">
                                Nom:</strong> &nbsp; {{ $company->name }}</li>
                        <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">N° Téléphone:</strong>
                            &nbsp; {{ $company->contact_phone }}</li>
                        <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong>
                            &nbsp; {{ $company->contact_email }}</li>
