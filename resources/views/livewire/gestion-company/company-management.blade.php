<div class="main-content">
                ...
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <button class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal"
                            data-bs-target="#createCompanyModal">+&nbsp; Nouvelle Entreprise</button>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($companies as $company)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="mx-3 btn"
                                                data-bs-toggle="tooltip" data-bs-original-title="Edit company" wire:click="edit({{$company->id }})">
    ...
    <div wire:ignore.self class="modal fade" id="createCompanyModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="@if ($company->id) update @else store @endif" action="#" method="POST" role="form text-left"
                        enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="company-logo"
                                        class="form-control-label">{{ __('Logo de l\'entreprise') }}</label>
                                    <div class="@error('company.logo')border border-danger rounded-3 @enderror">
                                        <input wire:model="company.logo" class="form-control" type="file"
                                            placeholder="Logo" id="company-logo">
                                    </div>
                                    @error('company.logo')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="company-name"
                                        class="form-control-label">{{ __('Nom Complet') }}</label>
                                    <div class="@error('company.name')border border-danger rounded-3 @enderror">
                                        <input wire:model="company.name" class="form-control" type="text"
                                            placeholder="Nom" id="company-name">
                                    </div>
                                    @error('company.name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="company-industry_sector"
                                            class="form-control-label">{{ __('Secteur Industriel') }}</label>
                                        <div
                                            class="@error('company.industry_secto')border border-danger rounded-3 @enderror">
                                            <input wire:model="company.industry_sector" class="form-control"
                                                type="text" placeholder="Secteur Industriel"
                                                id="company-industry_sector">
                                        </div>
                                        @error('company.industry_sector')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="company-contact_email"
                                            class="form-control-label">{{ __('Email') }}</label>
                                        <div
                                            class="@error('company.contact_email')border border-danger rounded-3 @enderror">
                                            <input wire:model="company.contact_email" class="form-control"
                                                type="email" placeholder="@example.com" id="company-contact_email">
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="company.contact_phone"
                                        class="form-control-label">{{ __('Phone') }}</label>
                                    <div
                                        class="@error('company.contact_phone')border border-danger rounded-3 @enderror">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="company.location"
                                        class="form-control-label">{{ __('Position') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="company.address"
                                        class="form-control-label">{{ __('Adresse') }}</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn bg-gradient-light btn-md mt-4 mb-4"
